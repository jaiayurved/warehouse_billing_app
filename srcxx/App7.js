...
import BuyerSelectionScreen from "./components/BuyerSelectionScreen";
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {tab === "review" && (
          <CartReview
            ...
            handleSubmit={() => setTab(isBilling ? "selectBuyer" : "finalReview")}
            totalCTN={totalCTN}
        ...
        {tab === "selectBuyer" && (
          <BuyerSelectionScreen
            ...
            onBuyerSelect={(buyer) => {
              localStorage.setItem("buyer_data", JSON.stringify(buyer));
              localStorage.setItem("invoicePayload", JSON.stringify({ buyer, cart, grandTotal }));
        ...
        {tab === "finalReview" && (
          <ReviewPanel
            ...
            onPrint={() => {
              ...
              localStorage.setItem("buyer_data", JSON.stringify(dummyBuyer));
